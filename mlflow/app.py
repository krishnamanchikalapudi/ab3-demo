...
# Refer: https://docs.aws.amazon.com/cdk/v2/guide/constructs.html
class DeploymentStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        CfnOutput(scope=self, id='artifact_bucket', value=artifact_bucket.bucket_name)
        ...
        container = task_definition.add_container(
            id='Container',
            image=ecs.ContainerImage.from_asset(directory='container'),  # Dockerfile at this directory
            environment={
...
app = App()
project_name="AB3DeploymentStack"
DeploymentStack(app, project_name) 
app.synth()
